...
public class TestLanceHiveAmoroCatalog extends TestLanceAmoroCatalog {

  @ClassRule public static TestHMS TEST_HMS = new TestHMS();

  public TestLanceHiveAmoroCatalog(AmoroCatalogTestHelper<?> amoroCatalogTestHelper) {
    super(amoroCatalogTestHelper);
  }

  @Parameterized.Parameters(name = "{0}")
  public static Object[] parameters() {
    return new Object[] {LanceHiveCatalogTestHelper.defaultHelper()};
  }
